...
namespace PhoneAppLibrary
{
    ...
    public class Person
    {
        ...
        public class Address
        {
            ...
            {
                this.Address1 = addstr[0];
                this.City = addstr[1];
                this.State = addstr[2];
                this.Zipcode = addstr[3];
                this.Country = addstr[4];
            }
        ...
        public void Print()
        {
            ...
            String s = String.Format("{0,5} {1,15} {2,15}", this.FirstName, this.LastName, this.Gender + ' ' + this.myAddress.Address1);
